...
app.get('/api/participantesxtorneo/:id', (req, res) => {
  ...
  const sql =
    'SELECT Usuario.Nombre FROM Ranking inner join Usuario on Ranking.UsuarioID = Usuario.UsuarioID inner join Torneo on Torneo.TorneoID = Ranking.TorneoID WHERE Ranking.TorneoID = ?'
